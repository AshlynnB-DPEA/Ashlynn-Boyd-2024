...
class MainScreen(Screen):
    def callback(self, dt):
        self.ids.label.text = "x_coord: " + str(joy.get_axis('x'))
        self.ids.label2.text = "y_coord: " + str(joy.get_axis('y'))

    def __init__(self, **kwargs):
        Clock.schedule_interval(self.callback, 0.001)
